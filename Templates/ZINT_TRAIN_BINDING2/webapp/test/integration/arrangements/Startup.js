sap.ui.define([
	"sap/ui/test/Opa5",
	"int/train/binding2/ZINT_TRAIN_BINDING2/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel"
], function (Opa5, mockserver, ODataModel) {
	"use strict";

	return Opa5.extend("int.train.binding2.ZINT_TRAIN_BINDING2.test.integration.arrangements.Startup", {
		...
		iStartMyApp: function (oOptionsParameter) {
			...
			this.iStartMyUIComponent({
				componentConfig: {
					name: "int.train.binding2.ZINT_TRAIN_BINDING2",
					async: true
				},
				hash: oOptions.hash,
