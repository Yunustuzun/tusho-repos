		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Rezervation Application",
									"targetURL": "#RezervationApplication-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"RezervationApplication-display": {
								"semanticObject": "RezervationApplication",
								"action": "display",
								"description": "Rezervation Application",
								"title": "Rezervation Application",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=int.train.rezervation.ZINT_TRAIN_REZERVATION",
									"url": sap.ui.require.toUrl("int/train/rezervation/ZINT_TRAIN_REZERVATION")
								}
							}
						}
					}
