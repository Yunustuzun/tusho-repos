sap.ui.define([
	"sap/ui/test/Opa5",
	"int/train/rezervation/ZINT_TRAIN_REZERVATION/localService/mockserver",
	"sap/ui/model/odata/v2/ODataModel",
	"sap/ui/core/routing/HashChanger",
	"int/train/rezervation/ZINT_TRAIN_REZERVATION/test/flpSandbox",
	"sap/ui/fl/FakeLrepConnectorLocalStorage"
], function(Opa5, mockserver, ODataModel, HashChanger, flpSandbox, FakeLrepConnectorLocalStorage) {
	"use strict";

	return Opa5.extend("int.train.rezervation.ZINT_TRAIN_REZERVATION.test.integration.arrangements.Startup", {
