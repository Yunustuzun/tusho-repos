sap.ui.define([
	...
	return BaseObject.extend("int.train.rezervation.ZINT_TRAIN_REZERVATION.controller.ListSelector", {
		 ...
		 * @class
		 * @public
		 * @alias int.train.rezervation.ZINT_TRAIN_REZERVATION.controller.ListSelector
		 */
